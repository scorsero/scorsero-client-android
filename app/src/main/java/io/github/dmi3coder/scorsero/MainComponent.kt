...
import io.github.dmi3coder.scorsero.data.source.local.LocalDataSourceModule
 ...
 */
@Singleton
@Component(modules = arrayOf(MainApplicationModule::class, LocalDataSourceModule::class))
